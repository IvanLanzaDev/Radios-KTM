...
<table class="table">
  ...
  <?php
    ...
    $count = 1;
    while($list_search_radios = mysqli_fetch_array($search_radios)){
        echo "
        <tr>
        <th scope='row'> $count</th>
        <td>$list_search_radios[name_radios]</td>
        <td><a href='info-radio.php?id_radio=$list_search_radios[id_radios]' class='btn btn-primary btn-sm'>Ver Informações</a></td>
        <td><a href='edit-radio.php?id_radio=$list_search_radios[id_radios]' class='btn btn-warning btn-sm'>Editar Informações</a></td>
      </tr>
        ";
        $count++;
    }
